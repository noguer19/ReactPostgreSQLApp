...
const FilmDetails = (props) => {
     ...
     const { film_id } = props.location.state;
                                   ...
                                   <div className="row">
                                        {
                                             film.map((filmData, index) => (
                                                  <div className="col text-center" key={index}>
                                                       <Link className="text-dark" to={{ pathname: "/ActorDetails", state: { actor_id: filmData.actor_id, film_id: film_id } }} title="watch details">
